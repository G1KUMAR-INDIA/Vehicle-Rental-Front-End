    ...
    <div className='bg-slate-100 duration-300 -z-20'>
      <div className="container min-h-[620px] flex">
        <div className='grid place-items-center grid-cols-1 sm:grid-cols-2'>
            <div data-aos="zoom" data-aos-duration="1000" className='order-1 sm:order-2'>
                {/* https://shorturl.at/arOEF */}
                <img src="https://shorturl.at/arOEF" alt="Vehicles" className='relative -z-10 max-h-[600px] sm:scale-125 drop-shadow-[2px_20px_6px_rgba(0,0,0,0.50)]' />
